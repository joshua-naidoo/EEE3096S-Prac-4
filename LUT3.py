...
filename = "drum.wav"  # Full file path
...
data = np.clip(data, 0, 4095)  # Clip to 0-4095
...
if start_idx > window_size:  # If peak is too far, use the start
    start_idx = 0
...
# Clip the resampled data to ensure 0-4095 range
segment = np.clip(segment, 0, 4095)
